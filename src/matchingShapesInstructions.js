...
function draw() {
  ...
  text('MOUSE ONLY!', width / 4, height * 7/9 / 800 * width);
  textSize(20);
  textAlign(CENTER, CENTER);
  text('Move the colored shape', width / 4, height / 4 - 100);
  text('to its similar white shape', width / 4, height / 4 - 75);
  text('(A green glow will appear if locked in)', width / 4, height / 4 - 40);
  //green glow
  ...
  textSize(20);
  textAlign(CENTER, CENTER);
  text('Match with the incorrect shape', width * 3/4, height / 4 - 100);
  text('and a yellow glow will appear', width * 3/4, height / 4 - 75);
  text('on the correct shape', width * 3/4, height / 4 - 50);
  //yellow glow
  ...
  button.display();
  fill('White');
  text('Click here', width / 2, height / 2 - 12);
  text('to continue', width / 2, height / 2 + 12);
}
